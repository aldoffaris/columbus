        ...
        <div class="navbar-wrapper  ">
            <div class="navbar-content scroll-div ">
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
                        <a href="index.php?halaman=produkdaftar" class="nav-link "><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Data Produk</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="index.php?halaman=pesan" class="nav-link "><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Data Pesan</span></a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <ul class="navbar-nav ml-auto">
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="pro-head">
                                <a href="index.php?halaman=ubahprofil">
    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            if (isset($_GET['halaman'])) {
                ...
                } elseif ($_GET['halaman'] == "produkdaftar") {
